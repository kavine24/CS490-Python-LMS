  ...
  <body>
    <header class="mainHeader">
      ...
      <ul class="navLIST">
          ...
          <li><a href="http://cs490testcenter.ddns.net:50000" onclick={() => { var result ='<? unset($_SESSION['login12344321']); unset($_SESSION['role']); ?>'; document.write(result); return true;}>Sign Out</a></li>
        </ul>
      <br>
    </header>
