...
<html>
  ...
  <body>
    <h1 class="text-center header">TEACHER LANDING PAGE</h1><br>
    <div id=mainDiv>
      <a id="makeQuestionButton" href="http://cs490testcenter.ddns.net:50000/portal/t/CreateQuestion.html">
        <input class="userSubmit" type="submit" placeholder="Submit" value="Create Questions"/>
      </a>
      <br>
      <a id="makeIdButton" href="http://cs490testcenter.ddns.net:50000/portal/t/CreateQuiz.html">
        <input class="userSubmit" type="submit" placeholder="Submit" value="Create Quiz"/>
      </a>
      <br>
      <a id="makeIdButton" href="http://cs490testcenter.ddns.net:50000/portal/t/ReviewAndGradeExams.html">
        <input class="userSubmit" type="submit" placeholder="Submit" value="Grade Quizzes"/>
      </a>
    </div>
    <script>
