<?php
  ...
  if ($data['requestType'] == 'LoginRequestFTM') {
    ...
    $post_data = array('difficulty' => $difficulty, 'questionType' => $questionType, 'prompt' => $prompt, 
      'inputvals' => $inputvals, 'outputvals' => $outputvals, 'requestType' => $requestType);
    ...
    $post_data = array('examName' => $examName, 'questionIDs' => $questionIDs, 'numPoints' => $numPoints, 'requestType' => $requestType);
