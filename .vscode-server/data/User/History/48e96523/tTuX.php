<?php
  ...
  else if ($_POST['requestType'] == 'AutoUpdateGradesMTB')
  {
    ...
    {
      $p = $pointsTable[$i]['studentAnswersID'];
      $h = $pointsTable[$i]['caseID'];
      $c = $pointsTable[$i]['ouput'];
      $f = $pointsTable[$i]['pointsEarned'];
      $studentAnswersID = $newGrades[$i]['studentAnswersID'];
      ...
      "VALUES (36, 60, "1", 0) " . 
      "ON DUPLICATE KEY UPDATE output= "2", pointsEarned= 1;";
